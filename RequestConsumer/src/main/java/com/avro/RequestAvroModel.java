...
public class RequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3362236741030859469L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RequestAvroModel\",\"fields\":[{\"name\":\"id\",\"type\":\"long\"}]}");
   ...
   */
  public RequestAvroModel(java.lang.Long id) {
    this.id = id;
  }
   ...
   */
  public static RequestAvroModel.Builder newBuilder() {
    return new RequestAvroModel.Builder();
  }
   ...
   * @return A new RequestAvroModel RecordBuilder
   */
  public static RequestAvroModel.Builder newBuilder(RequestAvroModel.Builder other) {
    if (other == null) {
      return new RequestAvroModel.Builder();
    } else {
      return new RequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new RequestAvroModel RecordBuilder
   */
  public static RequestAvroModel.Builder newBuilder(RequestAvroModel other) {
    if (other == null) {
      return new RequestAvroModel.Builder();
    } else {
      return new RequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(RequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(RequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public RequestAvroModel.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public RequestAvroModel.Builder clearId() {
